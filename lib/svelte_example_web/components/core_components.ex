defmodule SvelteExampleWeb.CoreComponents do
  @moduledoc """
  ...
  import SvelteExampleWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SvelteExampleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SvelteExampleWeb.Gettext, "errors", msg, opts)
    end
  end
